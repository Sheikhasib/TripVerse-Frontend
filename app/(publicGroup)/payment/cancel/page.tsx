...
function PaymentCancelContent() {
  ...
  return (
    <div className="w-full rounded-lg border border-dashed border-border bg-muted/20 px-6 py-16 text-center">
      ...
      <h1 className="mt-4 text-lg font-semibold">Payment cancelled</h1>
      <p className="mx-auto mt-1 max-w-sm text-sm text-muted-foreground">
        {booking
          ? "Your booking remains PENDING — you can pay again whenever you're ready."
          : "You cancelled the payment at the gateway. Your booking remains PENDING."}
      </p>
